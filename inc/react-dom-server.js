		...
		function d(d, h) {
			...
			if (f) {
				if (
					...
					var l = h.getDerivedStateFromProps.call(
						null,
						d.props,
						f.state
					);
		...
		sa = (function () {
			...
			b.clearProviders = function () {
				for (var a = this.contextIndex; 0 <= a; a--)
					this.contextStack[a][this.threadID] =
